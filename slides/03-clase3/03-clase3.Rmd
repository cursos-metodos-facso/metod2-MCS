...
pacman::p_load(dplyr, stargazer, ggplot2, summarytools, kableExtra)
...
Ejemplo gráfico alternativo de twitter:
...
* grafico piñera; grafico aprobación presidencial; grafico ejes distintos; grafico ejes escalas pequeñas.
