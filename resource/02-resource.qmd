...
linktitle: "Práctica 2: Operacionalización"
date: "2023-03-24"
lang: es
---
...
Realizamos un chequeo básico de la lectura de datos: nombres de las variables y tamaño de la base en términos de casos y variables (en este ejemplo, `r dim(latinobarometro2020)[1]` casos y `r dim(latinobarometro2020)[2]` variables).
