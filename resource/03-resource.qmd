...
linktitle: "Práctica 3: Visualización"
date: "2023-03-24"
lang: es
---
...
```{r warning=FALSE}
plot_grpfrq(proc_data$conf_inst,proc_data$educacion,
            type = "box")
```
...
```{r}
sjPlot::plot_stackfrq(dplyr::select(proc_data, conf_gob,
                                 conf_cong,
                                 conf_jud,
                                 conf_partpol),
...
```{r}
ggplot(proc_data, aes(x = as.numeric(edad))) +
