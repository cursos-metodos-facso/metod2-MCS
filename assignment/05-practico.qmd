...
4.  Cómo reportar y presentar matrices de correlación.
5.  Interpretar el tamaño de efecto de una correlación.
6.  Tratamiento de casos perdidos.
7.  Qué es y cómo calcular la correlación de Spearman.
8.  Qué es el coeficiente de determinación $R^2$.
...
## Estimación de la correlación de Pearson

Utilizaremos un set mínimo simulado de datos. 
